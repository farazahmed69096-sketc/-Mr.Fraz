...
function Hero() {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        transition={{duration:0.5,delay:0.7}}
        viewport={{once:true}}
            className='text-xs font-medium'>Trusted by 10k+ people</motion.h3>
        </motion.div>
            <motion.h1
        ...
        viewport={{once:true}}
             className='text-4xl sm:text-5xl md:text-6xl xl:text-[84] font-medium xl;leading-[95px] max-w-5xl'>Turning imaginations into <span className='bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent '>digitle</span> impact. </ motion.h1>
            <motion.p
        ...
        viewport={{once:true}}
            className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm;max-w-lg pb-3'>
                Creating meaning full connections and turning big ideas into interactive digitle eperience.
            </motion.p>
            <motion.div 
